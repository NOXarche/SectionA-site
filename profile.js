...
function renderProfile() {
  ...
  if (user.role === "admin") document.getElementById('adminBadge').style.display = "";
...
document.getElementById('editNameForm').onsubmit = function(e) {
  ...
  alert("Name updated! (Replace with Firebase update in production)");
};
...
saveSubsectionBtn.onclick = () => {
  ...
  alert("Subsection updated! (Replace with Firebase update in production)");
};
...
document.getElementById('changePasswordForm').onsubmit = function(e) {
  e.preventDefault();
  // Demo only; in production, validate and update via Firebase
  ...
  alert("Password changed! (Replace with Firebase update in production)");
};
